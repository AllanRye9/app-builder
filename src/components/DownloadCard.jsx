export default function DownloadCard({ apkUrl, filename }) {
  return (
    <a className="download-btn" href={apkUrl} download>
      ...
      Download APK
      <span className="download-hint">{filename?.replace(/\.zip$/i, '') || 'app'}.apk</span>
    </a>
  );
}
